...
summary: "Rob was the manager of the root system and he got offer to build the ecommerce from the health group. I have worked on the project as a member of root system.I build the frontend using Next.js + TypeScript + Tailwind CSS + Gsap and setup Strapi CMS for the content management. Collaborate with Jeff for the Woocommerce Setup"
images:
    - "/images/projects/lera/lera (1).png"
    - "/images/projects/lera/lera (2).png"
    - "/images/projects/lera/lera (3).png"
    - "/images/projects/lera/lera (4).png"
    - "/images/projects/lera/lera (5).png"
team:
#  - name: "Selene Yu"
